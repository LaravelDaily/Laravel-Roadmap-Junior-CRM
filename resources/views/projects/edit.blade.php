<x-layouts.app>
    ...
    <div class="mt-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700 pb-2 mb-6">
                    Files
                </h3>
                
                <form action="{{ route('media.upload', ['Project', $project]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <x-forms.input type="file" label="File" name="file" id="file" />
                    </div>
                    <x-button type="primary" tag="button" buttonType="submit">
                        Upload
                    </x-button>
                                    ...
                                    @foreach($project->getMedia() as $media)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                ...
                                                <form action="{{ route('media.delete', ['Project', $project, $media]) }}" method="POST"
